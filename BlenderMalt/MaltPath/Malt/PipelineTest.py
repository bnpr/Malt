...
class PipelineTest(Pipeline):
    ...
    def do_render(self, resolution, scene, is_final_render, is_new_frame):
        ...
        self.draw_scene_pass(self.fbo_prepass, scene.batches, 'PRE_PASS', self.default_shader['PRE_PASS'], UBOS)
        ...
        self.draw_scene_pass(self.fbo_main, scene.batches, 'MAIN_PASS', self.default_shader['MAIN_PASS'], UBOS, {}, textures, callbacks)        
